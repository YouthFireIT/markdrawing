...
<body class="full-screen-slider">
        <!-- ========== HEADER ========== -->
        <header id="header" class="u-header u-header-left-aligned-nav" style="position: -webkit-sticky;
  position: sticky;
  top: 0;">
            <div class="u-header__section">
                    ...
                    <div class="container">
                        <div class="d-flex align-items-center">
                            <div class="topbar-left">
                                <a href="#" class="text-gray-110 font-size-13 u-header-topbar__nav-link">Welcome to Dailydeal</a>
                            </div>
                ...
                <!-- Logo-Search-header-icons py-2 py-xl-5-->
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-auto">
                                ...
                                <a class="order-1 order-xl-0 navbar-brand u-header__navbar-brand u-header__navbar-brand-center" href="{{route('index')}}" aria-label="Electro">
                                        <img src="{{asset('images/'.$general->logo)}}" style="height:80px;width:80px" alt="logo">
                                    </a>
                                    <!-- End Logo -->
                                                    ...
                                                    <div id="headerSidebarContent" class="u-sidebar__content u-header-sidebar__content">
                                                        ...
                                                        <ul id="headerSidebarList" class="u-header-collapse__nav">
                                                            ...
                                                            <!-- Fruits -->
                                                                ...
                                                                @forelse(App\Category::where('parent_id',NULL)->orderBy('name','asc')->get() as $category)
                                                                    @if(App\Category::where('parent_id',$category->id)->first())
                                                                        <li class="u-has-submenu u-header-collapse__submenu">
                                                                            <a class="u-header-collapse__nav-link u-header-collapse__nav-pointer" href="" data-target="#subcategory{{ $category->id }}" role="button" data-toggle="collapse" aria-expanded="false" aria-controls="subcategory{{ $category->id }}">{{ $category->name }}</a>
                                                                            <div id="subcategory{{ $category->id }}" class="collapse" data-parent="#headerSidebarContent">
                                                                                <ul id="headerSidebarShopMenu" class="u-header-collapse__nav-list">
                                                                                    @forelse(App\Category::where('parent_id',$category->id)->orderBy('name','asc')->get() as $subcategory)
                                                                                    <li><a class="nav-link u-header__sub-menu-nav-link" href="{{url('product/subcategoryAll',$subcategory->id)}}">{{$subcategory->name}}</a></li>
                                                                                    @empty
                                                                                    @endif
                                                                                </ul>
                                                                            </div>
                                                                    ...
                                                                    @else
                                                                    <li class="u-has-submenu u-header-collapse__submenu">
                                                                        <a class="u-header-collapse__nav-link u-header-collapse__nav-pointer" href="{{ url('product/categoryAll',$category->id) }}">{{ $category->name }}</a>
                                                                    </li>
                                                                        <!--<li><a class="nav-link u-header__sub-menu-nav-link" href="{{ url('product/categoryAll',$category->id) }}">{{ $category->name }}</a></li>-->
                                                                    @endif
                                                                @empty
                                                                <li>Please add some category</li>
                                                                @endforelse
                                                            <!-- Fruits -->
                                ...
                                <div id="navBar" class="collapse navbar-collapse u-header__navbar-collapse">
                                    <ul class="navbar-nav u-header__navbar-nav">
                                        <li></li>
                                            ...
                                            <li>
                                                <a href="{{ route('products') }}" class="nav-link u-header__nav-link u-header__nav-link-toggle">Shop
                                            </a>
                                            </li>
                                            <li class="nav-item hs-has-sub-menu u-header__nav-item" data-event="hover" data-animation-in="slideInUp" data-animation-out="fadeOut">
                                                <a href="" class="nav-link u-header__nav-link u-header__nav-link-toggle">About
                                            </a>
                                        </li>
        ...
        <footer>
            <!-- Footer-top-widget -->
            <div class="container d-none d-lg-block mb-3" style="margin-right:90px">
                <div class="row">
            ...
            <div class="pt-8 pb-4 bg-gray-13">
                <div class="bg-shape">
                    <img src="http://dailydeal.com.bd/arabian-assets/img/bg.png" alt="bg-shape">
                </div>
                        ...
                        <div class="col-lg-5">
                            <div class="mb-6">
                                <a href="#" class="d-inline-block">
                                    <img src="{{asset('images/'.$general->logo)}}" width="200px" alt="logo">
                                </a>
                            </div>
                            <div class="mb-4">
